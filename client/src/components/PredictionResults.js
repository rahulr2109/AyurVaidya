  ...
  return (
    ...
    >
      ...
      <Box>
        ...
        >
          <Typography sx={{ fontSize: { lg: "25px", md: "30px", sm: "20px", xs: "20px" }, color: "secondary.main" }}><strong>Disease</strong>: {name}</Typography>
          <Typography sx={{ fontSize: { lg: "25px", md: "30px", sm: "20px", xs: "20px" }, color: "primary.main" }}><strong>Probability </strong>: {(chance * 100).toFixed()}%</Typography>
        </Box>
